...
; @ added perpendicular park(manual) and TEST DISTANCE
...
;	OUT    	XLEDS
	...
	JUMP	ReadRemote			; keeps looping through until one of the buttons is pressed
...
MoveBWD:
	...
	; Park Perpendicularly at press of single button	;
	;                                                   ;
	;---------------------------------------------------;
PerpPark:
	LOADI   	0			;Makes sure bot is facing straight
	STORE 		DTheta		
	LOADI		270			; preps for parking IN
	STORE		DTheta
	LOAD	FSlow  ;load in slow
	STORE	DVel   ;move into spot
